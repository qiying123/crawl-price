...
with st.sidebar:
    ...
    st.markdown("<h2 style='text-align: center;'>开发者名称</h2>", unsafe_allow_html=True)
    st.markdown("<p style='text-align: center; color: gray;'>全栈开发 / 爬虫工程师 / 数据分析</p>", unsafe_allow_html=True)
    st.divider()
    ...
    st.markdown("#### 🛠️ 技术栈")
    st.caption("Python • Scrapy • TiDB • Streamlit")
    st.markdown("#### 📧 联系方式")
